...
new_wrapper_start = '''{/* Grid for Atletas and Actividad Reciente */}
                            ...
                            {[
                                ...
                                <div key={idx} className={`p-4 transition-colors ${
                                    ...
                                    <div className="flex justify-between items-start mb-1">
                                        <p className={`text-sm font-bold flex flex-wrap items-center gap-1 ${isClinical ? 'text-slate-900' : 'text-white'}`}>
...
content = content.replace(start_str, new_wrapper_start)
content = content.replace(end_str, new_wrapper_end)
