...
async def migrate_athlete_drafts():
    """
    Convierte las columnas de la tabla athlete_drafts de Enum a VARCHAR en PostgreSQL.
    Esto permite que el backend envíe strings directamente sin errores de tipo.
    """
    commands = [
    ...
    print("🔨 Iniciando migración de athlete_drafts (Enum -> VARCHAR)...")
    ...
    print("\n✅ Migración de athlete_drafts completada.")

if __name__ == "__main__":
    asyncio.run(migrate_athlete_drafts())
